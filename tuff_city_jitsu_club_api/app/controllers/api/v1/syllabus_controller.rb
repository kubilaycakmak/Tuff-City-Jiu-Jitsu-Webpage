class Api::V1::SyllabusController < Api::ApplicationController
    ...
    def index
        syllabuses = Syllabus.order(created_at: :desc)
        render(json: syllabuses, each_serializer: SyllabusCollectionSerializer) # Find out what should be in this serializer
    end
