...
if belt_id >= 2
    # Randomly assign dark blue and brown belts Club Instructor (note, if they don't have this, we at least expect them to have Instructor instead, and then they MUST for grading to black belt)
end
...
puts Cowsay.say("Generated #{InstructorQualifcation.count} belt colours", :frogs) 
